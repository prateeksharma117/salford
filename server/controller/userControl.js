...
export const creatingUser=asyncHandler(async(req,res)=>{
...
export const favResidency=asyncHandler(async(req,res)=>{
    ...
    try {
        ...
        if (user.favResidenciesId.includes(rid)) {
            ...
            res.send({message:"add to favorites",user:updateUser})
        }
    } catch (e) {
        throw new Error(e.message)
    }
...
export const getAllFavResidency=asyncHandler(async(req,res)=>{
    const {email}=req.body
    try {
