...
const Facilities = ({
    ...
    const form = useForm({
        initialValues: {
            bedrooms: propertyDetail.facilities.bedrooms,
            parkings: propertyDetail.facilities.parkings,
            bathrooms:propertyDetail.facilities.bathrooms,
        },
        validate: {
    ...
    return (
        <Box className="box" mx="auto" my="sm">
            <form
                onSubmit={(e) => {
                    e.preventDefault();
                    handleSubmit();
